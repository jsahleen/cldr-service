...
createLanguage = async (req: express.Request, res: express.Response) => {
...
getLanguageById = async (req: express.Request, res: express.Response) => {
...
updateLanguageById = async (req: express.Request, res: express.Response) => {
...
replaceLanguageById = async (req: express.Request, res: express.Response) => {
...
removeLanguageById = async (req: express.Request, res: express.Response) => {
